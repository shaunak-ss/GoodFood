        ...
        <div>
            <nav className="navbar navbar-expand-lg navbar-dark bg-warning position-sticky"
                ...
                <div className="container-fluid">
                    <Link className="navbar-brand fs-1 fst-italic text-black" to="/">GoodFood</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <Link className="nav-link fs-5 mx-3 active text-black" aria-current="page" to="/">Home</Link>  {/* index.css - nav-link color white */}
                            </li>
                        ...
                        {(!localStorage.getItem("token")) ?
                            ...
                            <div>
                                ...
                                <button onClick={handleLogout} className="btn bg-white text-black" >Logout</button></div>}
                    </div>
                </div>
            </nav>
        </div>
